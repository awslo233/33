      ...
      <div className="flex items-center gap-1 px-2 py-1.5 rounded-xl bg-card border border-border">
        <Button
          ...
          className={`rounded-lg transition-all ${
            isBold
              ? 'bg-primary/15 text-primary shadow-[inset_0_1px_2px_rgba(0,0,0,0.15)] translate-y-px'
              : 'hover:bg-accent'
          }`}
          title="粗体"
        >
          <Bold className={`size-4 ${isBold ? 'text-primary' : 'text-muted-foreground'}`} />
        </Button>
        <Button
          variant="ghost"
          size="icon-sm"
          ...
          title="斜体"
        >
          <Italic className={`size-4 ${isItalic ? 'text-primary' : 'text-muted-foreground'}`} />
        </Button>
